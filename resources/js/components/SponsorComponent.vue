    ...
    <div class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-8 mx-auto">
                ...
                <div class="mt-6 space-y-8 xl:mt-12">
                    ...
                    <div class="flex items-center justify-between max-w-2xl px-8 py-4 mx-auto border cursor-pointer rounded-xl dark:border-gray-700" v-for="sponsor in fetchedSponsors" :key="sponsor.id"  :class = "sponsor.isActive = true ?'border-blue-700':'border-transparent'" @click="clicked(sponsor)">
